...
- (UIButton *)specialButton {
    if (_specialButton == nil) {
        ...
        [_specialButton setImage:[UIImage imageNamed:@"camera"] forState:UIControlStateNormal];
        [_specialButton setImage:[UIImage imageNamed:@"camera"] forState:UIControlStateHighlighted];
        // 发布按钮的点击事件
...
- (void)specialButtonClick {
    if ([self.delegate performSelector:@selector(specialButtonClick)]) {
